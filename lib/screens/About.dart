                ...
                child: Row(
                  ...
                  children: [
                    ElevatedButton.icon(
                        ...
                        style: ButtonStyle(
                            ...
                            foregroundColor: MaterialStateProperty.resolveWith(
                                (states) => Colors.mainColor),
                            backgroundColor: MaterialStateProperty.resolveWith(
                                (states) => Colors.white)),
                        onPressed: () async {
                          final Uri url = Uri.parse(
                              "mailto:cst21017@std.uwu.ac.lk?subject=Regarding%20GPA%20Calculator");
                          await launchUrl(url);
                        },
                    ...
                    ElevatedButton.icon(
                        ...
                        onPressed: () async {
                          final Uri url = Uri.parse(
                              "https://www.linkedin.com/in/sachindukavishka7070/");
                          await launchUrl(url);
                        },
                        label: const Text(
                          "Linkedin",
