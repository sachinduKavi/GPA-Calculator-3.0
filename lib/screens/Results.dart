...
class _ResultsState extends State<Results> {
  ...
  Future<void> _addResultSql(
      String moduleName, int credits, String grade) async {
  ...
  Future<void> _getResults() async {
    ...
    for (int i = 0; i < data.length; i++) {
      addModule(data[i]['course_id'], data[i]['module_name'],
          data[i]['credits'], data[i]['grade']);
    }
    updateGPA();
  }
              ...
              if (changeCount > 0 && uploadState) {
                showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        title: const Text(
                            "Data is not synchronized with the cloud"),
                        content: Row(
          ...
          child: Column(
            children: [
              Container(
                ...
                height: 120,
                decoration: BoxDecoration(
                    border: Border.all(color: Colors.activeColor, width: 5),
                  ...
                  child: Column(
                    children: [
                      ListView(
                        ...
                        shrinkWrap: true,
                        children: [Column(children: moduleList)],
                      ),
                      ...
                      SizedBox(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  width: 3, color: const Color(0xFFE9E9E8))),
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              const Text(
                              ...
                              Container(
                                ...
                                child: ElevatedButton(
                                    onPressed: () {
                                      changeCount++;
                                      print(
                                          '${moduleNameController.text} ${creditController.text} $selectedValue working');
